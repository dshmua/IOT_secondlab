...
//  HAL_UART_Transmit_IT(&huart1, msg, sizeof(msg));
  ...
  uint8_t msg[] = "Ready listening commands...\n\r";
  ...
  {
#ifdef RING_BUFFER_CODE
//	  if(HAL_UART_Transmit(&huart1, (uint8_t *) ".", 1, HAL_MAX_DELAY) != HAL_OK) {
//		  RingBuffer_Write(&txBuf, (uint8_t *) ".", 1);
//	  }
	#endif
//	  statusRx = HAL_UART_Receive(&huart1, rx1, sizeof(rx1), 1000);
//	  if(statusRx == HAL_OK) {
//		  HAL_UART_Transmit(&huart1, rx1, sizeof(rx1), HAL_MAX_DELAY);
//	  }
//	  if(statusRx == HAL_TIMEOUT) {
//		  HAL_UART_Transmit(&huart1, (uint8_t *) "\n\r\tSkip\n\r", 9, HAL_MAX_DELAY);
//	  }
//	  if(statusRx == HAL_ERROR) {
//		  HAL_UART_Transmit(&huart1, (uint8_t *) "\n\r\tError\n\r", 10, HAL_MAX_DELAY);
//	  }
//	  if(statusRx == HAL_BUSY) {
//		  HAL_UART_Transmit(&huart1, (uint8_t *) "\n\r\tBusy\n\r", 9, HAL_MAX_DELAY);
//	  }
//	  if(HAL_UART_Receive(&huart1, rx1, sizeof(rx1), HAL_MAX_DELAY) == HAL_OK) {
//		  HAL_UART_Transmit(&huart1, rx1, sizeof(rx1), HAL_MAX_DELAY);
//	  }
    /* USER CODE END WHILE */
...
//		HAL_UART_Transmit_IT(&huart2, tx2, 1);
	}
...
//		HAL_UART_Transmit_IT(&huart1, tx2, sizeof(tx2));
		HAL_UART_Receive_IT(&huart2, rx2, sizeof(rx2));
	}
}
/* USER CODE END 4 */
